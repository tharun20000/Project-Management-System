...
import { updateTaskStatus } from "../api/index";
...
const TaskCard = ({ item, index, members, updateTaskLocal }) => {
  const token = localStorage.getItem("token");
  const dispatch = useDispatch();

  const handleStatusUpdate = async (e) => {
    e.stopPropagation(); // Prevent modal from closing if any click listener is on Card
    const newStatus = item.status === "Working" ? "Completed" : "Working";
